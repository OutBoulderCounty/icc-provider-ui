...
const ProviderInfo: React.FC = () => {
    return (
        <>
            <form className="max-w-7xl mx-auto space-y-8 divide-y divide-gray-200">
                                ...
                                <div className="mt-1 sm:mt-0 sm:col-span-2">
                                    <div className="max-w-lg flex rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 block w-full focus:ring-violet-light focus:border-violet-light min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300"
                                        />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                        <div className="space-y-1 text-center">
                                            ...
                                            <div className="flex text-sm text-gray-600">
                                                <label
                                                    htmlFor="file-upload"
                                                    className="relative cursor-pointer bg-white rounded-md font-medium text-violet hover:text-violet-light focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-violet-light"
                                                >
                            ...
                            <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                                ...
                                <div className="mt-1 sm:mt-0 sm:col-span-2">
                                    <select
                                        ...
                                        className="max-w-lg block focus:ring-violet-light focus:border-violet-light w-full shadow-sm sm:max-w-xs sm:text-sm border-gray-300 rounded-md"
                                    >
